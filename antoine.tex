...
%
\begin{align*}
\max_{\{\a(\t)\}} &\int_{\t\in \N}\left( (1+\t)X-\a(\t)X\frac{1-F(\t)}{f(\t)}\right)f(\t)d\t.
\end{align*}
%
...
Firm 2 faces an adverse selection problem: all firm 1 of type $\t\in[0,\frac{c}{X}]$ have interest to accept the menu, take transfer $p$ as they know that the merger will not be carried on by firm 2. Thus the profits of firm 2 is:
