...
\] 
%
So..... do we have $\t_0=0$ (no data sharing), or $\t_0\in(\t_0,\overline \t)$ (mix sharing and no sharing), or $\t_0=\overline \t$ (only data sharing)? Derivative$V'(\t_0),V''(\t_0)$ look cumbersome to some, but should be done (along the lines of the previous note.)
