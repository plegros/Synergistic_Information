...
%
\[
V(\t_0):=\int_0^{\t_0} \left[\frac{X^2(1+\t)^2}{16}-\frac{L(\t_0)}{2}(2X-L(\t_0))\right]f(\t)d\t + \int_{\t_0}^{\overline \t} X^2 \frac{(1+\t)^3}{2(1+\t)+\frac{1-F(\t)}{f(\t_0)}}f(\t)d\t.
\] 

\todo[inline]{$V(\t_0):=\int_0^{\t_0} \left[\frac{X^2(1+\t)^2}{2}-\frac{(X-L(\t))^2}{2}-\frac{L(\t_0)}{2}(2X-L(\t_0))\right]f(\t)d\t + \int_{\t_0}^{\overline \t} X^2 \frac{(1+\t)^3}{2(1+\t)+\frac{1-F(\t)}{f(\t_0)}}f(\t)d\t.$}
%
Direct computation shows that 
%
\begin{align*}
V'(\t_0):=&\left[\frac{X^2}{16}(1+\t_0)^2-\frac{L(\t_0)}{2}(2X-L(\t_0))\right]f(\t_0)- F(\t_0)L'(\t_0)(X-L(\t_0))\\ 
&-X^2\frac{(1+\t_0)^3}{2(1+\t_0)+\ell(\t)}f(\t_0)   
\end{align*}
%

\todo[inline]{$V'(\t_0):=\left[\frac{X^2}{2}(1+\t_0)^2-\frac{X^2}{2}\right]f(\t_0)- F(\t_0)L'(\t_0)(X-L(\t_0))-X^2\frac{(1+\t_0)^3}{2(1+\t_0)+\ell(\t)}f(\t_0)$}
hence,
%
\[
...
\]
%
\todo[inline]{we have data sharing if $0<f(0)$ (always the case)}
